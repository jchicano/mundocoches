    ...
    <div class="collapse navbar-collapse" id="navbarResponsive">
      <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown" id="dropdownLoginLI">
          <button type="button" id="dropdownMenu1" data-toggle="dropdown" class="nav-link btn btn-outline-secondary dropdown-toggle"><i class="fas fa-user"></i> <span class="caret"></span></button>
