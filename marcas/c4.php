...
<?php $PAGE_TITLE = "Marcas | Citroën C4"; ?>
<!DOCTYPE html>
<html>
<head>
  ...
  <div class="container bg-light">
        ...
        <div class="bg-black text-center h-100 project">
          <div class="d-flex h-100">
            <div class="project-text w-100 my-auto text-center text-lg-left">
              <h4 class="text-white text-center">CITROËN C4</h4>
    ...
    <div class="row justify-content-center no-gutters mb-5 mb-lg-0 text-justify">
      <div class="col-lg-6 text-center">
        <img class="img-fluid margen w-100" src="../img/marcas/citroen-c4-ft.jpg" alt="C4">
      </div>
      <div class="col-lg-6 text-center">
    ...
    <div class="row justify-content-center no-gutters mb-5 mb-lg-0 text-justify">
      ...
      <div class="col-lg-12">
        <ul>
          <li>
            <a href="../analisis/analisis-c4.php">Análisis del C4</a>
          </li>
        </ul>
      </div>
    </div>
