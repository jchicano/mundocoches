...
<?php $PAGE_TITLE = "Marcas | BMW M2 Competition"; ?>
<!DOCTYPE html>
<html>
<head>
  ...
  <div class="container bg-light">
        ...
        <div class="bg-black text-center h-100 project">
          <div class="d-flex h-100">
            <div class="project-text w-100 my-auto text-center text-lg-left">
              <h4 class="text-white text-center">BMW M2 Competition</h4>
    ...
    <div class="row justify-content-center no-gutters mb-5 mb-lg-0 text-justify">
      <div class="col-lg-6 text-center">
        <img class="img-fluid margen w-100" src="../img/marcas/bmw-m2-ft.jpg" alt="M2 Competition">
      </div>
      <div class="col-lg-6 text-center">
    ...
    <div class="row justify-content-center no-gutters mb-5 mb-lg-0 text-justify">
      ...
      <div class="col-lg-12">
        <ul>
          <li>
            <a href="../analisis/analisis-m2-competition.php">Análisis del M2 Competition</a>
          </li>
        </ul>
      </div>
    </div>
